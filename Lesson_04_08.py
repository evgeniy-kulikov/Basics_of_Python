...
print(friend)
print(type(friend))
print('* * * * * * основные действия со словарем  * * * * * * ')
...
print('_ _ _ _ _ получение элемента по ключу _ _ _ _ _')
friend = {
    'name': 'Max',
    'age': 23,
    'has car': True
...
for key in friend:
    print(key)
    print(friend[key])
print('_ _ _ _ _ получаем значения ключей в словаре _ _ _ _ _')
for val in friend.values():
    print(val)
print('_ _ _ _ _ получаем пары  ключ:значение  в словаре _ _ _ _ _')
